...
!
  ...
  SAVE N1, N2, N3, M1, M2, M3, N1D, N2D, N3D, N4D, &
   ...
   BK1, BK2, BK3, BK4, BJN, BJP, AA, BB, DBK1, DBK2, DBK3, DBK4, &
   DBJP, DBJN, DAA, DBB
  ...
  DATA FPI12,SPI12,CON1,CON2,CON3/ &
   1.30899693899575D+00, 1.83259571459405D+00, 6.66666666666667D-01, &
   7.74148278841779D+00, 3.64766105490356D-01/
  DATA BK1(1),  BK1(2),  BK1(3),  BK1(4),  BK1(5),  BK1(6), &
       BK1(7),  BK1(8),  BK1(9),  BK1(10), BK1(11), BK1(12), &
       BK1(13), BK1(14), BK1(15), BK1(16), BK1(17), BK1(18), &
       BK1(19), BK1(20)/ 2.43202846447449D+00, 2.57132009754685D+00, &
  ...
  DATA BK2(1),  BK2(2),  BK2(3),  BK2(4),  BK2(5),  BK2(6), &
       ...
       BK2(19), BK2(20)/ 5.74830555784088D-01,-6.91648648376891D-03, &
  ...
  DATA BK3(1),  BK3(2),  BK3(3),  BK3(4),  BK3(5),  BK3(6), &
       ...
       BK3(19), BK3(20)/ 5.66777053506912D-01, 2.63672828349579D-03, &
  ...
  DATA BK4(1),  BK4(2),  BK4(3),  BK4(4),  BK4(5),  BK4(6), &
       ...
       BK4(13), BK4(14)/ 4.85444386705114D-01,-3.08525088408463D-03, &
  ...
  DATA BJP(1),  BJP(2),  BJP(3),  BJP(4),  BJP(5),  BJP(6), &
       ...
       BJP(19)         / 1.34918611457638D-01,-3.19314588205813D-01, &
  ...
  DATA BJN(1),  BJN(2),  BJN(3),  BJN(4),  BJN(5),  BJN(6), &
       ...
       BJN(19)         / 6.59041673525697D-02,-4.24905910566004D-01, &
  ...
  DATA AA(1),   AA(2),   AA(3),   AA(4),   AA(5),   AA(6), &
       ...
       AA(13),  AA(14) /-2.78593552803079D-01, 3.52915691882584D-03, &
  ...
  DATA BB(1),   BB(2),   BB(3),   BB(4),   BB(5),   BB(6), &
       ...
       BB(13),  BB(14) /-4.90275424742791D-01,-1.57647277946204D-03, &
  ...
  DATA DBK1(1), DBK1(2), DBK1(3), DBK1(4), DBK1(5), DBK1(6), &
       ...
       DBK1(19),DBK1(20), &
       DBK1(21)        / 2.95926143981893D+00, 3.86774568440103D+00, &
  ...
  DATA DBK2(1), DBK2(2), DBK2(3), DBK2(4), DBK2(5), DBK2(6), &
      ...
      DBK2(19),DBK2(20)/ 5.49756809432471D-01, 9.13556983276901D-03, &
  ...
  DATA DBK3(1), DBK3(2), DBK3(3), DBK3(4), DBK3(5), DBK3(6), &
      ...
      DBK3(19),DBK3(20)/ 5.60598509354302D-01,-3.64870013248135D-03, &
  ...
  DATA DBK4(1), DBK4(2), DBK4(3), DBK4(4), DBK4(5), DBK4(6), &
      ...
      DBK4(13),DBK4(14)/ 4.93072999188036D-01, 4.38335419803815D-03, &
  ...
  DATA DBJP(1), DBJP(2), DBJP(3), DBJP(4), DBJP(5), DBJP(6), &
       ...
       DBJP(19)        / 1.13140872390745D-01,-2.08301511416328D-01, &
  ...
  DATA DBJN(1), DBJN(2), DBJN(3), DBJN(4), DBJN(5), DBJN(6), &
       ...
       DBJN(19)        /-1.88091260068850D-02,-1.47798180826140D-01, &
  ...
  DATA DAA(1),  DAA(2),  DAA(3),  DAA(4),  DAA(5),  DAA(6), &
       ...
       DAA(13), DAA(14)/ 2.77571356944231D-01,-4.44212833419920D-03, &
  ...
  DATA DBB(1),  DBB(2),  DBB(3),  DBB(4),  DBB(5),  DBB(6), &
       ...
       DBB(13), DBB(14)/ 4.91627321104601D-01, 3.11164930427489D-03, &
