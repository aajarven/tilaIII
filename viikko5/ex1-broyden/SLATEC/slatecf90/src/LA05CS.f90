...
!
  ...
  return
!
  610 if (LP > 0) call XERMSG ('SLATEC', 'LA05CS', &
     'LENGTHS OF ARRAYS A(*) AND IND(*,2) ARE TOO SMALL.', -7, 1)
  G = -7.0E0
  return
!
  620 if (LP > 0) call XERMSG ('SLATEC', 'LA05CS', &
