...
!
  100 CONTINUE
  call XERMSG ('SLATEC', 'PPQAD', 'K DOES NOT SATISFY K >= 1', 2, &
     1)
  return
  105 CONTINUE
  call XERMSG ('SLATEC', 'PPQAD', 'LXI DOES NOT SATISFY LXI >= 1', &
     2, 1)
  return
  110 CONTINUE
  call XERMSG ('SLATEC', 'PPQAD', 'LDC DOES NOT SATISFY LDC >= K', &
     2, 1)
  return
end
