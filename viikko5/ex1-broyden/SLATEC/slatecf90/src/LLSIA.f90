...
!
  ...
  return
  502 call XERMSG ('SLATEC', 'LLSIA', 'M < 1', 2, 1)
  return
  503 call XERMSG ('SLATEC', 'LLSIA', 'N < 1', 2, 1)
  return
  504 call XERMSG ('SLATEC', 'LLSIA', 'N > M', 2, 1)
  return
  505 call XERMSG ('SLATEC', 'LLSIA', 'MDA < M', 2, 1)
  return
  506 call XERMSG ('SLATEC', 'LLSIA', 'LIW < M+N', 2, 1)
  return
  507 call XERMSG ('SLATEC', 'LLSIA', 'NB < 0', 2, 1)
  return
  508 call XERMSG ('SLATEC', 'LLSIA', 'MDB < M', 2, 1)
  return
  ...
  INFO=-1
  return
  511 call XERMSG ('SLATEC', 'LLSIA', 'RE(I)  <  0', 2, 1)
  return
  512 call XERMSG ('SLATEC', 'LLSIA', 'RE(I)  >  1', 2, 1)
  return
  513 call XERMSG ('SLATEC', 'LLSIA', 'AE(I)  <  0', 2, 1)
  return
